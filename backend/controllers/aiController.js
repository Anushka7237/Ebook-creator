...
const generateOutline = async (req, res) => {
  try {
    ...
    3. Each chapter description should 2-3 sentences explaining what the chapters cover
    4. Ensure chapters build upon each other conherently
    ...
    [
        ...
        },
        {
            ...
            "description":"Explores the fundamentals principles and theories. Provides detailed examples and real-world applications."
        }
    ]
    ...
    if (startIndex === -1 || endIndex === -1) {
      console.error("Could not found JSON array in AI response", text);
      return res
        .status(500)
    ...
    try {
      ...
      res.status(500).json({
        message:
          "Failed to generate a valid outline. The AI responses was not valid JSON.",
      });
    }
  } catch (error) {
...
const generateChapterContent = async (req, res) => {
  try {
    ...
    3. Include relevant examples, explanationa, or anecdotes as appropriate for the style
